public class MathOperations {
    public static void main(String[] args) {
        ...
        int collectedResults = bagOfSweets1 + bagOfSweets2;
        int diferenceResults = bagOfSweets2 - bagOfSweets1;

        System.out.println(String.format("Fred and George collected %d sweets", collectedResults));
